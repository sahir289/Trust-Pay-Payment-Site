...
function AmountPage() {
    ...
    return (
        ...
        >
                        ...
                        <div className="flex flex-col px-2 mt-2 py-1 flex justify-center">
                            ...
                            <div className="flex justify-center">
                                <button onClick={handleAmountSubmit} 
                                    className="bg-gradient-to-r from-green-400 to-blue-500 w-[80vw] sm:w-[70vw] xl:w-[25vw] 2xl:w-[20vw] lg:w-[35vw] py-2 text-lg text-white shadow-lg transform transition-transform duration-300 hover:scale-105 rounded-lg mb-2 mt-4"
                                >
                                    Submit
                                </button>
                            </div>
            ...
            {visible && <Upi amount={amount} />}
            {visibleBank && <BankTransfer amount={amount} />}
